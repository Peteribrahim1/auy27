...
class EditMasjid extends StatefulWidget {
  EditMasjid({super.key, required this.data, required this.fire_id});
  String? poll;
  final QueryDocumentSnapshot<Map<String, dynamic>> data;
  final String fire_id;

  @override
  State<EditMasjid> createState() => _EditMasjidState();
}

class _EditMasjidState extends State<EditMasjid> {
  Uint8List? _image;
  ...
  void initState() {
    ...
    _nameOfRepController.text = widget.data['name_rep'];
    ...
    _denominationController.text = widget.data['denomination'];
    _membersController.text = widget.data['members'];
  ...
  void _saveData() async {
    ...
    String res = await AuthMethods().editMasjid(
