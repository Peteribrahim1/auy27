...
class EditPolitical extends StatefulWidget {
  EditPolitical({super.key, required this.data, required this.fire_id});
  String? poll;
  final QueryDocumentSnapshot<Map<String, dynamic>> data;
  final String fire_id;

  @override
  State<EditPolitical> createState() => _EditPoliticalState();
}

class _EditPoliticalState extends State<EditPolitical> {
  Uint8List? _image;
  ...
  void _saveData() async {
    ...
    String res = await AuthMethods().editPoliticalGroup(
